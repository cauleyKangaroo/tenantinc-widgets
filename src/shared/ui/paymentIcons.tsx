...
// ===========================================================================
// Payment-method brand marks for the order-summary rail (shared).
// Self-contained inline SVGs so each bundle stays a single AMD file (Duda
// requirement) — no remote brand assets. Visa / Mastercard / Discover sit in a
// bordered white chip; Amex fills its chip blue; Apple Pay and Google Pay
// render as bare marks.
// ===========================================================================
