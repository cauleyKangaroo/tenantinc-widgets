...
export function FilterPanel({
  ...
  return (
    <aside className={`sl-filter-panel${collapsed ? ' collapsed' : ''}`}>
      <div className="sl-filter-header" onClick={onToggleCollapse}>
        <div className="sl-filter-title-row">
          <span className="sl-filter-icon">
        ...
        <div className="sl-filter-header-right">
          <button
          ...
          <span className="sl-filter-chevron">
      ...
      <div className="sl-filter-body">
            ...
            <div className="sl-filter-section">
              ...
              <div className="sl-pills">
                {SIZE_OPTIONS.map((opt) => (
                  <button
                    key={opt.value}
                    className={`sl-pill${filters.sizes.includes(opt.value) ? ' active' : ''}`}
                    onClick={() =>
          ...
          <div className="sl-filter-section">
            ...
            <div className="sl-pills sl-pills-wrap">
              {featureOptions.map((name) => (
                <button
                  key={name}
                  className={`sl-pill${filters.features.includes(name) ? ' active' : ''}`}
                  onClick={() =>
        ...
        <div className="sl-filter-right-group">
          <div className="sl-filter-section">
